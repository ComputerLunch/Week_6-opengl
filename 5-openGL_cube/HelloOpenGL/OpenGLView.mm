...
-(void)render:(CADisplayLink*)displayLink {
  ...
  //  m = glm::scale(m , glm::vec3( fingerPnt.x * 0.2));
  //  m = glm::rotate(m, fingerPnt.y, glm::vec3(0.0f, 90.0f, 0.0f));
    m = glm::scale(m , glm::vec3(2.0));
    m = glm::rotate(m, k, glm::vec3(0.0f, 0.0f, 1.0f));
    m = glm::rotate(m, k, glm::vec3(0.0f, 1.0f, 0.0f));
    glUniformMatrix4fv(g->_modelViewUniform, 1, 0, glm::value_ptr(m));
    

    drawMeshTexture(g->m_cube, g->t_obama);
...
-(void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event{
    ...
    fingerPnt = [touch locationInView:self];
}
...
-(void)setupTextures{ 
    ...
    g->t_obama = [self setupTexture:@"obama.png"];
    g->t_snow = [self setupTexture:@"snow.png"];
