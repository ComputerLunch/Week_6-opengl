...
struct vertex_struct m_cube_vertices[] = {
	...
	{1.0f,  1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f, TEX_COORD_MAX, 0.0f},
	{1.0f, -1.0f,  1.0f, 1.0f, 0.0f, 1.0f, 0.0f, TEX_COORD_MAX,TEX_COORD_MAX},
	{1.0f, -1.0f, -1.0f, 1.0f, 0.0f, 1.0f, 0.0f, 0.0f, TEX_COORD_MAX},
    ...
    {1.0f, -1.0f, 1.0f, 0.0f, 1.0f,  1.0f, 0.0f, TEX_COORD_MAX, 0.0f},
	{1.0f,  1.0f, 1.0f, 0.0f, 1.0f,  1.0f, 0.0f, TEX_COORD_MAX,TEX_COORD_MAX},
	{-1.0f, 1.0f, 1.0f, 0.0f, 1.0f,  1.0f, 0.0f, 0.0f, TEX_COORD_MAX},
